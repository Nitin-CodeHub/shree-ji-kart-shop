    ...
    <section className="bg-gradient-to-r from-orange-50 to-green-50 py-16">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-8 md:mb-0 fade-in-left">
            <h1 className="text-4xl md:text-6xl font-bold text-gray-800 mb-4">
              Fresh Groceries
              <span className="text-orange-600 pulse-soft"> Delivered</span>
            </h1>
            <p className="text-xl text-gray-600 mb-6 stagger-1">
              Get fresh vegetables, fruits, and daily essentials delivered to your doorstep from your trusted neighborhood store.
            </p>
            <div className="flex space-x-4 stagger-2">
              <Button 
                size="lg" 
                className="bg-orange-600 hover:bg-orange-700 text-white px-8 py-3 hover-lift"
              ...
              <Button 
                variant="outline" 
                size="lg" 
                className="border-orange-600 text-orange-600 hover:bg-orange-50 px-8 py-3 hover-lift"
                onClick={handleViewCategories}
              >
                View Categories
              </Button>
            </div>
            <div className="flex items-center mt-6 space-x-8 stagger-3">
              <div className="text-center hover-glow p-2 rounded">
          ...
          <div className="md:w-1/2 md:pl-12 fade-in-right">
            <div className="bg-white rounded-2xl shadow-2xl p-8 transform rotate-2 hover:rotate-0 transition-transform duration-500 hover-lift hover-glow">
              <img
